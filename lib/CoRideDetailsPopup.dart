...
class _CoRideDetailsPopupState extends State<CoRideDetailsPopup> {
      ...
      child: Stack(
        ...
        children: [
          Padding(
            ...
            child: _isLoading
                ? const SizedBox(height: 150, child: Center(child: CircularProgressIndicator(color: Color(0xFF14B8A6))))
                : _session == null
                ? const SizedBox(height: 100, child: Center(child: Text('Could not load ride details.')))
                : _buildContent(),
          ),
          Positioned(
            top: -12,
  ...
  Widget _buildContent() {
    ...
    final isActive = s['is_active'] == true || status == 'Active';
    final canTrackLive = s['can_track_live'] == true;
    ...
    switch (status) {
      ...
      default:
        ...
        statusLabel = canTrackLive ? '🟢 Live' : 'Active';
    }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(creatorName, style: const TextStyle(color: Colors.white70, fontSize: 13)),
              ],
            ),
          ),
          ...
          _detailRow(
            Icons.event_seat,
            'Available Seats',
            isActive ? '$availableSeats seat${availableSeats != 1 ? 's' : ''}' : 'N/A',
            valueColor: availableSeats > 0 ? const Color(0xFF16A34A) : const Color(0xFFDC2626),
          ),
          const SizedBox(height: 10),
          _detailRow(Icons.monetization_on, 'Fare per person', '৳${s['fare_per_person'] ?? 'N/A'}',
          ...
          if (!isActive) ...[
            Container(
              ...
              child: Text(
                status == 'Completed' ? 'This trip has already been completed.' : 'This CoRide has been canceled.',
            ...
            if (canTrackLive) ...[
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Track Live Location', style: TextStyle(color: Color(0xFF14B8A6))),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: availableSeats > 0 ? const Color(0xFF14B8A6) : Colors.grey.shade400,
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                ),
                child: _isBooking
                    ? const SizedBox(
                    ...
                    : Text(availableSeats > 0 ? 'Book Now' : 'Fully Booked',
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(value, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: valueColor ?? const Color(0xFF1F2937))),
            ],
          ),
        ),
      ],
